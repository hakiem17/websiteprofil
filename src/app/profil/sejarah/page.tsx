...
export const metadata: Metadata = {
    title: "Sejarah",
    description: "Sejarah dan perjalanan Dinas Komunikasi dan Informatika Pemerintah Daerah.",
};

export default async function SejarahPage() {
    const page = await getProfilePage("sejarah");
    ...
    return (
        <>
            <PageHero
                title={page.title}
                subtitle="Perjalanan pembentukan dan perkembangan instansi"
                breadcrumbs={[
