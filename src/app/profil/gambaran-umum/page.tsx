...
export const metadata: Metadata = {
    title: "Gambaran Umum",
    description: "Gambaran umum Dinas Komunikasi dan Informatika Pemerintah Daerah.",
};

export default async function GambaranUmumPage() {
    const page = await getProfilePage("gambaran-umum");
    ...
    return (
        <>
            <PageHero
                title={page.title}
                subtitle="Profil dan struktur unit kerja perangkat daerah"
                breadcrumbs={[
                    { label: "Profil", href: "/profil/visi-misi" },
                    { label: "Gambaran Umum Unit Kerja" },
                ]}
            />
